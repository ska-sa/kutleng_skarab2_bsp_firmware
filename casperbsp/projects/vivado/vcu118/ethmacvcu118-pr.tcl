...
#
# ethmacvcu118-pr.tcl: Tcl script for re-creating project 'vcu118projectpr'
#
# Generated by Vivado on Fri Mar 06 15:19:13 SAST 2020
...
#
# 1. This project restoration tcl script (ethmacvcu118-pr.tcl) that was generated.
#
...
set script_file "ethmacvcu118-pr.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../../.Xilinx/Vivado/2019.2/xhub/board_store"] [file normalize "$origin_dir/../../../../../../../../.Xilinx/Vivado/2019.1/xhub/board_store"]" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/EthMACPHY100GQSFP24x/EthMACPHY100GQSFP24x.xci"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/vio_packer/vio_packer.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/axis_ila_server/axis_ila_server.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/vio_reg/vio_reg.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/EthMACPHY100GQSFP14x/EthMACPHY100GQSFP14x.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/axis_stream_data_tx_rx_ila/axis_stream_data_tx_rx_ila.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/ila_datapacker/ila_datapacker.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../project_flow/vcu118projectpr/vcu118projectpr.srcs/sources_1/ip/vio_stripper/vio_stripper.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
