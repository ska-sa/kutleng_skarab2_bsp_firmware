...
foreach p $partials {
    ...
    #eval $cmd 
    set cmd "write_cfgmem -force -format BIN -interface SMAPx32 -disablebitswap -loadbit \"up 0x00000000 pr_bitstreams/$p.bit\" pr_bitstreams/$p"
    eval $cmd 
}
...
set    cmd "write_cfgmem -force -format MCS -interface SPIx4 -size 256 -loadbit \"up 0x00000000 pr_bitstreams/${static}.bit"
