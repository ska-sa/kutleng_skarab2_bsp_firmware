...
set_property PACKAGE_PIN   Y2  [get_ports qsfp2_mgt_rx0_p]
set_property PACKAGE_PIN   Y1  [get_ports qsfp2_mgt_rx0_n]
set_property PACKAGE_PIN   V7  [get_ports qsfp2_mgt_tx0_p]
set_property PACKAGE_PIN   V6  [get_ports qsfp2_mgt_tx0_n]

set_property PACKAGE_PIN   W4  [get_ports qsfp2_mgt_rx1_p]
set_property PACKAGE_PIN   W3  [get_ports qsfp2_mgt_rx1_n]
set_property PACKAGE_PIN   T7  [get_ports qsfp2_mgt_tx1_p]
set_property PACKAGE_PIN   T6  [get_ports qsfp2_mgt_tx1_n]

set_property PACKAGE_PIN   V2  [get_ports qsfp2_mgt_rx2_p]
set_property PACKAGE_PIN   V1  [get_ports qsfp2_mgt_rx2_n]
set_property PACKAGE_PIN   P7  [get_ports qsfp2_mgt_tx2_p]
set_property PACKAGE_PIN   P6  [get_ports qsfp2_mgt_tx2_n]

set_property PACKAGE_PIN   U4  [get_ports qsfp2_mgt_rx3_p]
set_property PACKAGE_PIN   U3  [get_ports qsfp2_mgt_rx3_n]
set_property PACKAGE_PIN   M7  [get_ports qsfp2_mgt_tx3_p]
set_property PACKAGE_PIN   M6  [get_ports qsfp2_mgt_tx3_n]

#QSFP1

set_property PACKAGE_PIN   T2  [get_ports qsfp1_mgt_rx0_p]
set_property PACKAGE_PIN   T1  [get_ports qsfp1_mgt_rx0_n]
set_property PACKAGE_PIN   L5  [get_ports qsfp1_mgt_tx0_p]
set_property PACKAGE_PIN   L4  [get_ports qsfp1_mgt_tx0_n]

set_property PACKAGE_PIN   R4  [get_ports qsfp1_mgt_rx1_p]
set_property PACKAGE_PIN   R3  [get_ports qsfp1_mgt_rx1_n]
set_property PACKAGE_PIN   K7  [get_ports qsfp1_mgt_tx1_p]
set_property PACKAGE_PIN   K6  [get_ports qsfp1_mgt_tx1_n]

set_property PACKAGE_PIN   P2  [get_ports qsfp1_mgt_rx2_p]
set_property PACKAGE_PIN   P1  [get_ports qsfp1_mgt_rx2_n]
set_property PACKAGE_PIN   J5  [get_ports qsfp1_mgt_tx2_p]
set_property PACKAGE_PIN   J4  [get_ports qsfp1_mgt_tx2_n]

set_property PACKAGE_PIN   M2  [get_ports qsfp1_mgt_rx3_p]
set_property PACKAGE_PIN   M1  [get_ports qsfp1_mgt_rx3_n]
set_property PACKAGE_PIN   H7  [get_ports qsfp1_mgt_tx3_p]
set_property PACKAGE_PIN   H6  [get_ports qsfp1_mgt_tx3_n]
